        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item active" href="/taoshelf/8088/card_old">已使用卡密</a>
                </div>
            </li>
    ...
    <div class="table-responsive">
        <table class="table table-hover table-sm">
            ...
            <tr>
                ...
                <td>${card.usedTime?string('yyyy-MM-dd HH:mm:ss')}</td>
                <td>${card.user.nick}</td>
            </tr>
            </#list>
            </tbody>
        </table>
    ...
    new Vue({
        ...
        methods: {
            handleSizeChange(val) {
                window.location.href = "/taoshelf/8088/card_old?page_no=" + this.currentPage + "&page_size=" + val;
            },
            handleCurrentChange(val) {
                window.location.href = "/taoshelf/8088/card_old?page_no=" + val + "&page_size=" + this.pageSize;
            }
        },
        data() {
            return {
